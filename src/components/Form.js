...
const options = [{value:'alcohol-free', label:'Alcohol-Free'}, {value:'celery-free', label:'Celery-Free'}, {value:'crustacean-free', label:'Crustacean-Free'}, {value:'dairy-free', label:'Dairy'}, {value:'egg-free', label:'Eggs'}, {value:'fish-free', label:'Fish'}, {value:'gluten-free', label:'Gluten'}, {value:'kidney-friendly', label:'Kidney Friendly'}, {value:'kosher', label:'Kosher'}, {value:'low-potassium', label:'Low Potassium'}, {value:'lupine-free', label:'Lupine-Free'}, {value:'mustard-free', label:'Mustard-Free'}, {value:'No-oil-added', label:'No oil added'}, {value:'low-sugar', label:'No-Sugar'}, {value:'paleo', label:'Paleo'}, {value:'peanut-free', label:'Peanuts'}, {value:'pescatarian', label:'Pescatarian'}, {value:'pork-free', label:'Pork-Free'}, {value:'red-meat-free', label:'Red meat-Free'}, {value:'sesame-free', label:'Sesame-Free'}, {value:'shellfish-free', label:'Shellfish'}, {value:'soy-free', label:'Soy'}, {value:'sugar-conscious', label:'Sugar-Conscious'}, {value:'tree-nut-free', label:'Tree Nuts'}, {value:'vegan', label:'vegan'}, {value:'vegan', label:'Vegan'}, {value:'vegetarian', label:'Vegetarian'}, {value:'keto-friendly', label:'Keto'}, {value:'wheat-free', label:'Wheat-Free'}]
